...
const Navbar = ({ navImg, navName, navData }: Props) => {
      ...
      >
        <div className="pageWidth flex items-center justify-between max-lg:p-3 max-md:p-2">
          <div className="flex-center gap-4">
            ...
            <h2
              className="brandText text-3xl max-lg:text-2xl cursor-pointer text-white"
              onClick={moveTop}
            >
              {navName}
            </h2>
          ...
          <div className="flex-center gap-16 max-lg:hidden">
            {navData
              ...
              .map((v) => GetLink(v.title, v.hyperLink, "NORMAL"))}
          </div>
